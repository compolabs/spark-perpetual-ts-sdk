...
const abi = {
  ...
  "functions": [
    ...
    },
    {
      ...
      "name": "get_max_repaid_settlement_and_liquidatable_collateral",
      "output": "41bd1a98f0a59642d8f824c805b798a5f268d1f7d05808eb05c4189c493f1be0",
      "attributes": [
        {
          "name": "storage",
...
export class Vault extends Contract {
  ...
  declare functions: {
    ...
    liquidate_collateral: InvokeFunction<[trader: IdentityInput, token: AssetIdInput, settlement_amount: BigNumberish], BN>;
    pause_trading: InvokeFunction<[], void>;
    remove_admin: InvokeFunction<[admin: IdentityInput], void>;
    resume_trading: InvokeFunction<[], void>;
    withdraw_collateral: InvokeFunction<[token: AssetIdInput, amount: BigNumberish], BN>;
    get_account_value_and_total_collateral_value: InvokeFunction<[trader: IdentityInput], [I64Output, I64Output]>;
    get_collateral_balance: InvokeFunction<[trader: IdentityInput, token: AssetIdInput], BN>;
    get_free_collateral: InvokeFunction<[trader: IdentityInput], BN>;
    get_free_collateral_by_token: InvokeFunction<[trader: IdentityInput, token: AssetIdInput], BN>;
    get_max_abs_position_size: InvokeFunction<[trader: IdentityInput, base_asset: AssetIdInput, trade_price: BigNumberish], [BN, BN]>;
    get_max_repaid_settlement_and_liquidatable_collateral: InvokeFunction<[trader: IdentityInput, token: AssetIdInput], [BN, BN]>;
