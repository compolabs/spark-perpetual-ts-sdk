import SparkPerpetual, { OrderType } from "../src/index";

import { DEFAULT_MARKET, initializeSparkPerpetual } from "./utils";
...
function subscribeAllOrders(spark: SparkPerpetual, limit: number) {
...
// Fetch all orders
async function fetchAllOrders(spark: SparkPerpetual, limit: number) {
...
// Fetch trade volume
async function fetchTradeVolume(spark: SparkPerpetual) {
